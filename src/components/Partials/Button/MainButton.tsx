...
export const buttonVariants = cva(
  [
    "flex items-center justify-center min-w-[65px] px-4 py-2.5 rounded-4xl focus:outline-none focus:ring-2 text-xs lg:text-base font-semibold",
  ...
  ],
  {
    variants: {
      variant: {
        ...
        text: "text-purple underline hover:text-purple/70 active:text-purple/80 focus:ring-0",
